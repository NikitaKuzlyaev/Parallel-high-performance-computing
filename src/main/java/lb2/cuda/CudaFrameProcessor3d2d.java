...
public class CudaFrameProcessor3d2d implements GpuFrameProcessor {

    private final CUcontext context;
    private final CUmodule module;
    private final CUfunction function;

    public CudaFrameProcessor3d2d(String ptxPath) {
        ...
        cuModuleGetFunction(function, module, "embossDownscale2x_3d2d");
    }
